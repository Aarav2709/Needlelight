...
const activeFilter = ref("all"); // 'all' | 'installed' | 'available'
const busyMods = ref(new Set()); // mods currently being installed/uninstalled
...
<template>
  <div class="p-6 flex flex-col gap-5">
    ...
    <div class="flex items-end justify-between gap-4">
      <div>
        <h1 class="m-0 text-2xl font-extrabold">Mod Catalog</h1>
        <p class="text-secondary mt-1 mb-0 text-sm">
          {{ allMods.length }} mods available &middot;
    ...
    >
      ...
      <template v-else> No mods available. </template>
    </div>
