...
async function checkForUpdate() {
  // Update checking disabled for Needlelight - updates distributed separately
  return;
}
...
const messages = defineMessages({
  ...
  body: {
    ...
    defaultMessage:
      "Needlelight v{version} is available. Use your package manager to update for the latest features and fixes!",
  },
  download: {
