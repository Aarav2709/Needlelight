...
// NOTE (Needlelight): BaseTerminal needs @xterm/* and belongs to Modrinth's server console.
// Excluded along with the other hosting-only code. Source file is untouched on disk.
