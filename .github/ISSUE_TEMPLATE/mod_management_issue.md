...
**Please note**: Needlelight is a mod management tool and is not responsible for issues with third-party mods themselves. If the mod is broken, incompatible, or has bugs, please contact the mod author directly. We can only help with issues related to Needlelight's mod management functionality (installation, uninstallation, enabling/disabling, etc.).
...
- [ ] I understand this is a Needlelight management issue, not a mod-specific problem
