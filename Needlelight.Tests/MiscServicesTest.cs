...
{
    /// <summary>
    /// We want to test whether or not Needlelight can successfully read the mod version from Modding.ModHooks class
    ...
    /// <summary>
    /// We want to test whether or not Needlelight can successfully get the global settings file for a mod
