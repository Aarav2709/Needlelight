...
namespace Lumafly.ViewModels
{
  public partial class SettingsViewModel : ViewModelBase
  {
    ...
    // Available game profiles for the UI. Keys correspond to GameProfiles keys.
    public ObservableCollection<string> AvailableGames => new(new[] { Lumafly.Models.GameProfiles.HollowKnight.Name, Lumafly.Models.GameProfiles.Silksong.Name });

    public string SelectedGame
    {
      get => (_settings.Game ?? Lumafly.Models.GameProfiles.HollowKnightKey) switch
      {
        var s when s.Equals(Lumafly.Models.GameProfiles.SilksongKey, StringComparison.OrdinalIgnoreCase) => Lumafly.Models.GameProfiles.Silksong.Name,
        _ => Lumafly.Models.GameProfiles.HollowKnight.Name,
      };
      set
      {
        // Map display name back to internal key
        var key = value == Lumafly.Models.GameProfiles.Silksong.Name ? Lumafly.Models.GameProfiles.SilksongKey : Lumafly.Models.GameProfiles.HollowKnightKey;
