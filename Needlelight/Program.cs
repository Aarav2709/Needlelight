...
namespace Needlelight
{
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("Starting Needlelight...");
            SetupLogging();
        ...
        private static void WriteExceptionToLog(Exception e)
        {
            ...
            try
            {
                // in a try just incase Needlelight is in a proteced folder
                ...
                .ConfigureFonts(manager =>
                {
                    try
                    {
                        manager.AddFontCollection(new EmbeddedFontCollection(
                            ...
                            new Uri("avares://Needlelight/Assets/Fonts/NotoSansSC", UriKind.Absolute)));
                        manager.AddFontCollection(new EmbeddedFontCollection(
                            new Uri("fonts:Noto Sans", UriKind.Absolute),
                            new Uri("avares://Needlelight/Assets/Fonts/NotoSans", UriKind.Absolute)));
                    }
                    catch
                    {
