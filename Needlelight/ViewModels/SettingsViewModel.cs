...
namespace Needlelight.ViewModels
{
  public partial class SettingsViewModel : ViewModelBase
  {
    ...
    public ObservableCollection<string> AvailableGames => new(new[] { Needlelight.Models.GameProfiles.HollowKnight.Name, Needlelight.Models.GameProfiles.Silksong.Name });

    public string SelectedGame
    {
      get => (_settings.Game ?? Needlelight.Models.GameProfiles.HollowKnightKey) switch
      {
        var s when s.Equals(Needlelight.Models.GameProfiles.SilksongKey, StringComparison.OrdinalIgnoreCase) => Needlelight.Models.GameProfiles.Silksong.Name,
        _ => Needlelight.Models.GameProfiles.HollowKnight.Name,
      };
      set
      {
